...
export type ScenarioCategory = "leadership" | "international" | "clients" | "teammates";
...
export const CATEGORY_ORDER: ScenarioCategory[] = ["teammates", "international", "clients", "leadership"];
